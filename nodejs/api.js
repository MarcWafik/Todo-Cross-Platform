...
app.get("/todo/:id", function (req, res) {
	Todo.Read(req.params.id, new Responce(req, res).Send);
});

app.get("/todo/all/:id", function (req, res) {
...
app.listen(3000, function () {
	console.log("\tREST API server started listening on port:3000 \t URL: http://localhost:3000/");
});
module.exports = app;